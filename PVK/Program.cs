...
ApartmentBuilding apartment = new ApartmentBuilding("Bachyně 17",
    new Flat(new ContactPerson("Tomáš", "Kuchtík", 605417824), PVK, new WaterMeter("789FGH"), "1.1"),
    new Flat(new ContactPerson("Roman", "Horlivý", 74222354), PVK, new WaterMeter("M85FGA"), "1.2"),
